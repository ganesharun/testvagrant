Feature: validate weather information from different sources and enables a comparison between them
#
  Scenario Outline:
    ...
    Then check if the difference in temperature is less than "1"
    Examples:
    |city|
    |Chennai|
    |Bengaluru|
